  ...
  useEffect(() => {
    ...
    if (
      ...
      titles.forEach((title, index) => {
        (title as HTMLDivElement).style.paddingTop = `${tops[index]}px`;
      });
    }
  }, []);
    ...
    const handleScroll = () => {
      ...
      titles.forEach((t, i) => {
        ...
        if (lastPinnedIndex > -1 && i <= lastPinnedIndex) {
          ...
          title.style.borderRight = `1px solid ${lastPinnedIndex === 2 ? "#1F1F1F" : "#DFDFDF"}`;
        ...
        >
          <Box
            ...
            sx={{
              display: "flex",
              alignItems: "center",
              width: isAtBottom ? 32 : isPinned ? 0 : 40,
